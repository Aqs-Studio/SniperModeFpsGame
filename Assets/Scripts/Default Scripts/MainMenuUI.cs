...
public class MainMenuUI : MonoBehaviour {
    ...
    public GameObject DaiyBonusMultiplePanel;
    ...
    public static bool firstLoad = false;
        ...
        AdHandler.singleton.ShowBanner();
        ...
        if (PlayerPrefs.GetInt("DailyBonusMultiplePanel")== 1)
        {
            ...
            DaiyBonusMultiplePanel.SetActive(true);
        }
        else
        {
    ...
    {
        if (!DaiyBonusMultiplePanel.activeInHierarchy == true) 
        {
            AdHandler.singleton.ShowInterstitialAd();
        }
        ...
        DaiyBonusMultiplePanel.SetActive(false);
    }
