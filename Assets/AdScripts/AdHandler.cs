...
public class AdHandler : MonoBehaviour
{
    ...
    public string bannerIPhoneID;

    public string interstitialAndroidID;
    public string interstitialIPhoneID;

    public string rewardedAndroidID;
    public string rewardedIPhoneID;
    ...
    public static AdHandler singleton;

    private static string strAdsOff = "Ads_Off";

    private bool isBannerOn = true;

    public void TurnAdsOff()
    {
        PlayerPrefs.SetInt(strAdsOff, 1);
        DestroyBannerAd();
    }

    public bool IsAdsOff()
    {
        return PlayerPrefs.GetInt(strAdsOff, 0) == 1;
    }
...
#elif UNITY_ANDROID
        string adUnitId = bannerAndroidID;
#elif UNITY_IPHONE
        string adUnitId = bannerIPhoneID;
#else
    ...
    public void RequestAndLoadInterstitialAd()
    {
        ...
        string adUnitId = "unused";
#elif UNITY_ANDROID
        string adUnitId = interstitialAndroidID;
#elif UNITY_IPHONE
        string adUnitId = interstitialIPhoneID;
#else
        string adUnitId = "unexpected_platform";
#endif
    ...
    public void RequestAndLoadRewardedAd()
    {
        ...
        string adUnitId = "unused";
#elif UNITY_ANDROID
        string adUnitId = rewardedAndroidID;
#elif UNITY_IPHONE
        string adUnitId = rewardedIPhoneID;
#else
        string adUnitId = "unexpected_platform";
#endif
